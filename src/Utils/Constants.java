...
{
	public static final int STANDARD_FRAME_WIDTH = 1050;
	public static final int STANDARD_FRAME_HEIGHT = 700;

	public static final int STANDARD_ARENA_WIDTH = 1000;
	public static final int STANDARD_ARENA_HEIGHT = 550;

	public static final int STANDARD_PLAYER_AREA_HEIGHT = 40;
	...
	public final static int STANDARD_HP = 10;
